...
import model_area_data from "../../assets/datas/model_area2.json";
...
const returnSrc = (index:number) =>{
  return `http://43.142.17.108:9200/static/xianglushan/2/`+index+`.png`
}
let index:any;
const MountainCard2 = (props: mountainCard) => {
...
const click3 = (e:any) => {
  ...
  return (
    <>
      ...
      <CameraFlyTo
            destination={
                Cartesian3.fromDegrees(99.996226,26.788154,100000)
            }
          ></CameraFlyTo>
        <Tabs
          style={{bottom:50}}
