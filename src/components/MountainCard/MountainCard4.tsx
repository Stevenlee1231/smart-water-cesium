...
const returnSrc = (index:number) =>{
  return `http://43.142.99.61:9200/static/xianglushan/4/`+index+`.png`
}
let index:any;
      ...
      <CameraFlyTo
        ...
        >
          ...
          <TabPane tab="模拟水位" key="2">
            ...
            <Button style={{height:30}} onClick={click(4)}>工况四</Button>
            <Button style={{height:30}} onClick={click(5)}>工况五</Button>
            <Button style={{height:30}} onClick={click(6)}>工况六</Button>
            {/* <Radio.Group
              options={SWL_options}
              optionType="button"
              buttonStyle="solid"
